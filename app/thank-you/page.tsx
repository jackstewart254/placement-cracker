...
import { Copy, Check } from "lucide-react"; // icons for copy/confirm
                ...
                {referralCode && (
                  <div className="text-center w-full">
                    ...
                    <p className="mt-4 text-sm font-medium text-left">
                      This is your referral code. Share it and get friends to
                      sign up for <strong>free access</strong> to:
                    </p>
                    <p className="text-sm mt-2 text-muted-foreground text-left mb-4">
                      <strong>3</strong> Cover Letter Generations{" "}
                      <strong>And</strong> <strong>5</strong> ResolveAI
                      Questions <strong>for every friend</strong> you sign up!
                    </p>
                    <Button
